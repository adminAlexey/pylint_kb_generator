...
id: pylint-R1737
rule_code: "R1737"
rule_name: "use-yield-from"
category: "pylint"
tags: ["python"]
related: []
source: "https://pylint.readthedocs.io/en/latest/user_guide/messages/messages_overview.html"
link: "https://pylint.readthedocs.io/en/latest/user_guide/messages/refactor/use-yield-from.html"
---
...
`yield from` can be thought of as removing the intermediary (your for loop) between the function caller and the
...
PEP 380 describes the possibility of adding optimizations specific to `yield from`. It looks like they
have not been implemented as of the time of writing. Even without said optimizations, the following snippet shows
that `yield from` is marginally faster.
